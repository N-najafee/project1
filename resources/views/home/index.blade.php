...
@section('content')
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-6">
                            <div class="slider-single-img slider-animated-1">
                                <img class="animated" src="{{url(env('BANNER_IMAGES_UPLOAD_PATH'),$slider->image)}}" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="banner-area pt-100 pb-65">
        <div class="container">
            <div class="row">
                @foreach($indextop as $index)
                <div class="col-lg-4 col-md-4">
                    <div class="single-banner mb-30 scroll-zoom">
                        <a href="product-details.html"><img class="animated" src="{{url(env('BANNER_IMAGES_UPLOAD_PATH'),$index->image)}}" alt="" /></a>
